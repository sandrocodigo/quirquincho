...
@Component({
  selector: 'app-ingreso-producto-ingreso',
  templateUrl: './ingreso-producto-ingreso.component.html',
  styleUrls: ['./ingreso-producto-ingreso.component.scss'],
  standalone: true,
  imports: [
    CommonModule,
...
export class IngresoProductoIngresoComponent {
  buscadorFormGroup: FormGroup;
  buscadorControl = false;
  displayedColumns: string[] = ['fecha', 'pc', 'pv', 'cantidad', 'cantidadSaldo', 'opciones'];
  dataSource: any;
