...
@Component({
  selector: 'app-producto-egreso',
  templateUrl: './producto-egreso.component.html',
  styleUrls: ['./producto-egreso.component.scss'],
  standalone: true,
  imports: [
    CommonModule,
...
export class ProductoEgresoComponent {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ProductoEgresoComponent>,
