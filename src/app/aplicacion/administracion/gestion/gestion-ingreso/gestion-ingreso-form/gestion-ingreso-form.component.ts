...
@Component({
  selector: 'app-gestion-ingreso-form',
  templateUrl: './gestion-ingreso-form.component.html',
  styleUrl: './gestion-ingreso-form.component.scss',
  standalone: true,
  imports: [
    CommonModule,
...
export class GestionIngresoFormComponent {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<GestionIngresoFormComponent>,
    ...
    this.ingresoDetalleServicio.obtenerPorId(data.id).then(respuesta => {
      this.registroFormGroup = this.fb.group({
        ...
        cantidad: [{ value: respuesta.cantidad, disabled: true }, Validators.pattern('^[1-9][0-9]*$')],
        pc: [
          respuesta.pc,
